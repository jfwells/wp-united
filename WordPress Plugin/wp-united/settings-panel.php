...
function wpu_get_help() {
	...
	<div class="wrap" id="wp-united-setup">
		...
		<p><?php _e('Please copy and paste the following information into a new topic post when you are seeking support. This will help us understand your setup at a glance. It is sanitized to protect your private server information and contains BBCode formatting.'); ?> </p>
		<div style="border: 1px solid #cccccc;font-family: monospace;"><?php echo $wpuDebug->get_debug_info(); ?></div>
	</div>
	<?
