...
function wpu_setup_menu() {
	...
	<form name="wpu-setup" id="wpusetup" method="post" onsubmit="return wpu_transmit('wp-united-setup', this.id);">
		...
		<div id="phpbbpathgroup">
			...
			<p id="wpubackupgroup" style="display: none;"><strong><input id="phpbbdocroot" style="font-size: 11px;color: #aaaaaa; border: 0 0 1px 0 dotted #cccccc; width: auto;" name="phpbbdocroot" value="<?php echo $docRoot; ?>"></input><input type="text" id="wpubackupentry" name="wpubackupentry" value="<?php echo $showBackupPath; ?>"></span></input>/config.php</strong></p>
